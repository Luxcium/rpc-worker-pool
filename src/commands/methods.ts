...
export async function helloworld2(
  ...
  try {
    ...
    DEBUG &&
      console.log(
        chalk.redBright('Hello world will echo back request as received:')
      );
    DEBUG &&
      console.dir(
        { ['AS RECEIVED']: true, ...rpcRequest },
 ...
 */
export const methodsImplementation: Record<
  string,

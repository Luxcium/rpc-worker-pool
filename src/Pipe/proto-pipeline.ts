...
//   }
// }
// export class ProcessStepComposable_<T, R>
...
//   public compose<U>(composeWith: (input: R) => U): ProcessStepComposable_<T, U> {
//     const transform: (input: T) => R = this._transform;
//     const composedTransform = (input: T) => composeWith(transform(input));
//     return new ProcessStepComposable_<T, U>(composedTransform);
//   }
// }
